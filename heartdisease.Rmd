...
```{r figacc, echo=F, fig.width=8, fig.cap="Accuracy rates for the three classification methods"}
...
```{r figlambda, echo=F, fig.width=8, fig.cap="Finding the minimum $\\lambda$ with ten-fold cross-validation (Run 5)"}
...
```{r figk, echo=F, fig.width=8, fig.cap="Finding the optimal k with leave-one-out cross-validation (Run 5)"}
...
```{r figsize, echo=F, fig.width=8, fig.cap="Finding the best size with ten-fold cross-validation (Run 5)"}
