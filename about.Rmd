...
In the Applied Health Research Centre at St. Michael’s Hospital, I am working closely with [Dr. Charles Keown-Stoneman](http://stmichaelshospitalresearch.ca/researchers/charles-keown-stoneman/), an Investigator/Biostatistician within the [TARGetKids!](https://www.targetkids.ca/about) research group. I am classified as a Research Visitor, and the title that best describes my role is Junior Biostatistician. My work is on the TARGetKids! COVID-19 Study, specifically studying COVID-19 public health measure adherence amongst parents and children in the Greater Toronto Area. Methods include linear mixed effects regression, piecewise linear regression, bootstrapping, cross-validation, LASSO regularization.

# Export Development Canada
My responsibilities as a Business Intelligence Analyst at EDC included working in R (tidyverse, caret) to predict customer retention and conversion of EDC insurance products using logistic regression and random forest classifiers. Additionally, I created dashboards in PowerBI and Excel to provide succinct summaries of targets and results for key metrics such as retention rates for SVPs, VPs, and other leaders at EDC. I also produced weekly reports which involve querying data and running SAS EG projects and process flows. 
